...
[pscustomobject]@{
    ...
    bridge_build_id_expected = 'synapse-chrome-bridge-2026-06-16-target-info-text-1206-v1'
    bridge_build_sha256_expected = '3ab6a7287913bbd234e8c1283e2fd0e8814f229bd6df6853287c358a973271a9'
    bridge_required_capabilities = @('closeTab', 'navigateTab', 'openTab', 'reloadSelf', 'targetInfo', 'targetInfoPageText', 'typeActiveElement')
