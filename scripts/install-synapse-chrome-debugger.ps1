...
[pscustomobject]@{
    ...
    bridge_build_id_expected = 'synapse-chrome-bridge-2026-06-21-click-options-v1'
    bridge_build_sha256_expected = 'fbee19874f831616a1b46dc945a0ed5778dfea67a45c4f680e1abc83eea6cadf'
