...
[pscustomobject]@{
    ...
    bridge_build_id_expected = 'synapse-chrome-bridge-2026-06-17-csp-evaluate-debugger-v3'
    bridge_build_sha256_expected = 'de1c08fc48f48763f93b4f64296556b8401e575ec0e39356a3e69a51c8d1b12c'
