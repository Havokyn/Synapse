...
use crate::{
    ...
    m1::{
        ...
        CdpNavigateTabResponse, CdpOpenTabParams, CdpOpenTabResponse, CdpTargetInfoParams,
        CdpTargetInfoResponse, FindParams, FindResponse, HiddenDesktopPipFrameParams,
