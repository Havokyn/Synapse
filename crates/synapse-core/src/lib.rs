...
pub use types::{
    ...
    OcrResult, OcrWord, PERCEIVED_TEXT_UNTRUSTED_NOTICE, PROFILE_SCHEMA_VERSION, PadButton, PadId,
    PathPoint, PathSpec, PerceptionMode, Point, Profile, ProfileBackends, ProfileCapture,
