...
| `CF_OCR_CACHE` | OCR cache row JSON | `schema_version`, `cache_key`, `created_at`, requested/effective `OcrBackend`, `lang`, source `region`, captured bitmap dimensions/byte count, `bitmap_sha256`, `OcrResult`, recognition latency, word count | `ocr/cache/v1/<requested_backend>/<effective_backend>/<lang_sha256>/<x>/<y>/<w>/<h>/<bitmap_width>/<bitmap_height>/<bitmap_sha256>` |
